...
private fun ArtSpace() {
    ...
    when (artworkIndex) {
        0 -> {
            artwork = R.drawable.anime__aot
            artworkDescription = R.string.anime__aot_description
            artworkName = R.string.anime__aot_title
            artworkReleaseYear = R.string.twentytwentyone
            artworkGenre = R.string.author__aot
        }
        1 -> {
            artwork = R.drawable.anime__bsd
            artworkDescription = R.string.anime__bsd_description
            artworkName = R.string.anime__bsd_title
            artworkReleaseYear = R.string.twentytwentyone
            artworkGenre = R.string.author__bsd
        }
        2 -> {
            artwork = R.drawable.anime__mushoku
            artworkDescription = R.string.anime_mushoku_description
            artworkName = R.string.anime__mushoku_title
            artworkReleaseYear = R.string.twentytwentytwo
            artworkGenre = R.string.author__mushoku

        }
        else -> {
            artwork = R.drawable.anime__jk
            artworkDescription = R.string.anime__jk_description
            artworkName = R.string.anime__jk_title
            artworkReleaseYear = R.string.twentytwentythree
            artworkGenre = R.string.author__jk
        }
    }
